...
const Static = () => {
  ...
  <div className="container px-5 py-24 mx-auto ">
    ...
    <div className="flex flex-wrap -m-4 text-center border-d border-4 border-violet-900">
      <div className="p-4 md:w-1/4 sm:w-1/2 w-full ">
        <div className="border-4 border-white px-4 py-6 rounded-lg bg-violet-400">
