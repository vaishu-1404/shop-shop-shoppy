...
const Cart = () => {
  ...
  return (
    <div className="container mx-auto mt-10 bg-violet-200">
      <div className="flex shadow-md my-10 border-4 border-violet-400">
        <div className="w-3/4 px-10 py-10 bg-violet-200">
        ...
        <div id="summary" className="w-1/4 px-8 py-10">
          <h1 className="font-semibold text-2xl border-b-2 border-white pb-8">Order Summary</h1>
