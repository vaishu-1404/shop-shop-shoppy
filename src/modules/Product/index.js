...
const Product = () => {
  ...
  return (
    ...
    <section className="text-gray-600 body-font overflow-hidden bg-violet-200">
      <div className="container px-5 py-24 mx-auto">
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          <img alt={product?.title} className="lg:w-1/2 w-full lg:h-auto max-h-[600px] h-64 border-4 bg-white border-violet-400 object-contain object-center rounded" src={product?.image}/>
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div className="flex justify-between items-center">
                ...
                <button className="rounded-full w-10 h-10 bg-pink-300 p-0 border-2 border-white inline-flex items-center justify-center text-gray-500 ml-4">
